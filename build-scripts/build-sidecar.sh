...
make -C $MAKEDIR docker IMAGE_NAME=amalgam8/a8-sidecar:0.2 DOCKERFILE=./docker/Dockerfile.ubuntu
STATUS=$?
if [ $STATUS -ne 0 ]; then
...
make -C $MAKEDIR docker IMAGE_NAME=amalgam8/a8-sidecar:0.2-alpine DOCKERFILE=./docker/Dockerfile.alpine
STATUS=$?
if [ $STATUS -ne 0 ]; then
